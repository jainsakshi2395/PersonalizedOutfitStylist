...
EMBEDDED_FEATURES_FILE_PATH = '/home/ubuntu/data/embeddings.pkl'  # path to AWS-EC2
...
FILENAMES_PATH = '/home/ubuntu/data/filenames.pkl'  # path to AWS-EC2
...
IMG_FOLDER_PATH = '/home/ubuntu/media'  # path to AWS-EC2
