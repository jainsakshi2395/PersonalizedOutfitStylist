...
# EMBEDDED_FEATURES_FILE_PATH = '/home/ubuntu/masters-project-v2-testing/data/embeddings.pkl'  # path to AWS-EC2
...
# FILENAMES_PATH = '/home/ubuntu/masters-project-v2-testing/data/filenames.pkl'  # path to AWS-EC2
...
# IMG_FOLDER_PATH = '/home/ubuntu/masters-project-v2-testing/media'  # path to AWS-EC2
